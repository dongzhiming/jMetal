...
import static org.uma.jmetal.util.Filter.filter;
...
//        return (n >= m) ? factorial(n) / factorial(n - m) / factorial(m) : 0;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < num; i++) {
            data[i] = getRandomWeightVector(m);
        }

//        new SmilePlot(m, "test1").scatter(data, 'o', Color.RED);
//
//        double[][] w = generateWeightVector(num, 2);
//        new SmilePlot(w[0].length, "test2").scatter(w, 'o', Color.GREEN);
//
//        w = generateWeightVector(num, 3);
//        new SmilePlot(w[0].length, "test3").scatter(w, '*', Color.RED);
//
//        w = generateWeightVector(105, 3);
//        new SmilePlot(w[0].length, "test4").scatter(w, 'O', Color.BLUE);
    }
}
